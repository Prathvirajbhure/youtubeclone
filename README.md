...
*  Modular Header:** Includes a functional search bar layout, voice search integration, and utility icons (Upload, Notifications, Profile).
* Collapsible Sidebar:** A vertical navigation system that organizes user subscriptions and library shortcuts.
*  Dynamic Video Grid:** Built with **CSS Grid** to handle multiple aspect ratios and metadata overlays (Duration, Channel Branding).
